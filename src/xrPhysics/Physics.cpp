...
#pragma warning(pop)
		...
		if(usr_data_2){
			usr_data_2->pushing_b_neg	=	usr_data_2->pushing_b_neg	&& !GMLibrary().GetMaterialByIdx(usr_data_2->b_neg_tri->data.material)->Flags.test(SGameMtl::flPassable);
			usr_data_2->pushing_neg		=	usr_data_2->pushing_neg		&& !GMLibrary().GetMaterialByIdx(usr_data_2->neg_tri->data.material)->Flags.test(SGameMtl::flPassable);
		...
		///////////////////////////////////////////////////////////////////////////////////////
		if(usr_data_1){ 
			usr_data_1->pushing_b_neg	=	usr_data_1->pushing_b_neg	&& !GMLibrary().GetMaterialByIdx(usr_data_1->b_neg_tri->data.material)->Flags.test(SGameMtl::flPassable);
			usr_data_1->pushing_neg		=	usr_data_1->pushing_neg		&& !GMLibrary().GetMaterialByIdx(usr_data_1->neg_tri->data.material)->Flags.test(SGameMtl::flPassable);

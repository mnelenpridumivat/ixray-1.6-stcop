...
bool ESceneSoundEnvTool::LoadJSON(nlohmann::json& file)
{
...
void ESceneSoundEnvTool::SaveJSON(nlohmann::json& file, int id)
{
	inherited::SaveJSON	(file, id);
	file["main"]["version"] = SOUND_ENV_TOOLS_VERSION;
}

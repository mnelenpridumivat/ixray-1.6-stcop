...
public:
	...
	virtual StaticWallmarkHandle::WallmarkHandlePtr add_DynamicWallmark(const wm_shader& S, const Fvector& P, float s, CDB::TRI* T, Fvector* V) override { return nullptr;}

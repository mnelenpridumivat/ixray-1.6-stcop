...
public:
	...
	IC		bool						Search			(_vertex_id_type start_vertex_id, _vertex_id_type dest_vertex_id,xr_vector<_vertex_id_type>& OutPath, _edge_weight_type MaxRange = std::numeric_limits<_edge_weight_type>::max(), u32 MaxIterationCount = 0xFFFFFFFF, u32 MaxVisitedNodeCount = 0xFFFFFFFF, _edge_weight_type* LastCost = nullptr) const;

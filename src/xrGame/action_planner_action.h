...
public:
	...
	virtual void Save(CSaveObjectSave* Object) const override { inherited_planner::Save(Object); inherited_action::Save(Object); };
	virtual void Load(CSaveObjectLoad* Object) override { inherited_planner::Load(Object); inherited_action::Load(Object); };

...
void player_hud::ResetBlockedPartID() { m_blocked_part_idx = u16(-1); }

void player_hud::SetHandsVisible(bool val) { m_bhands_visible = val; }

bool player_hud::GetHandsVisible() { return m_bhands_visible; }

IKinematics* player_hud::GetLegsModel() { return m_legs_model; }

bool player_hud::GetIsLegsShown() { return m_show_legs; }

void player_hud::SetIsLegsShown(bool shown) { m_show_legs = shown; }

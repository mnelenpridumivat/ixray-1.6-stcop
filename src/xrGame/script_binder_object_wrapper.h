...
public:
	...
	virtual void Save_static(CScriptBinderObject* script_binder_object, CSaveObject* Object);
	virtual void Load(CSaveObject* Object);
	virtual void Load_static(CScriptBinderObject* script_binder_object, CSaveObject* Object);

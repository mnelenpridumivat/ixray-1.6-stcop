...
DEFINE_MIXED_DELEGATE_SCRIPT_NAME(gamespy_gp::account_operation_cb, "account_operation_cb", account_operation_cb);
DEFINE_MIXED_DELEGATE_SCRIPT_NAME(gamespy_gp::account_profiles_cb, "account_profiles_cb", account_profiles_cb);
DEFINE_MIXED_DELEGATE_SCRIPT_NAME(gamespy_gp::found_email_cb, "found_email_cb", found_email_cb);

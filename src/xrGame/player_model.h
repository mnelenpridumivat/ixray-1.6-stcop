...
class player_model: public first_person_player_interface
{
public: 
					player_model(bool invert = false);
					~player_model();
	...
	virtual bool			GetHandsVisible() override { return true; };

	virtual IKinematics* GetLegsModel() override;
	virtual bool GetIsLegsShown() override { return true; };
